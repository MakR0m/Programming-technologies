namespace SOLID
{
    ...
    {
        // SRP (Single Responsobility) (Принцип единственной ответственности).
        ...
        //"Модули верхнего уровня не должны зависеть от модулей нижнего уровня. И те и другие должны зависит от абстракций".\
        //Абстракции не должны зависеть от деталей. Детали должны зависеть от абстракций."
        //Класс высокоуровневой логики (например, сервис б.л.) не напрямую зависеть от реализации базы данных, отправки емейл, логирования и т.д.
        //Вместо этого он должен зависеть от интерфейсов (асбтракций), а конкретные реализации внедряются снаружи (DI - Dependency Injection)
